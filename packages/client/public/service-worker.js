...
This is generally NOT safe. Learn more at https://bit.ly/wb-precache`;
  ...
  // ../../node_modules/.pnpm/workbox-core@6.5.3/node_modules/workbox-core/clientsClaim.js
  function clientsClaim() {
    self.addEventListener("activate", () => self.clients.claim());
  }

  // ../../node_modules/.pnpm/workbox-strategies@6.5.3/node_modules/workbox-strategies/utils/messages.js
  var messages2 = {
  ...
  // ../../node_modules/.pnpm/workbox-strategies@6.5.3/node_modules/workbox-strategies/plugins/cacheOkAndOpaquePlugin.js
  ...
  // ../../node_modules/.pnpm/workbox-strategies@6.5.3/node_modules/workbox-strategies/NetworkFirst.js
  ...
  // ../../node_modules/.pnpm/workbox-cacheable-response@6.5.3/node_modules/workbox-cacheable-response/_version.js
  try {
    self["workbox:cacheable-response:6.5.2"] && _();
  } catch (e) {
  }

  // ../../node_modules/.pnpm/workbox-cacheable-response@6.5.3/node_modules/workbox-cacheable-response/CacheableResponse.js
  ...
  // ../../node_modules/.pnpm/workbox-cacheable-response@6.5.3/node_modules/workbox-cacheable-response/CacheableResponsePlugin.js
  ...
  registerRoute(({ url }) => url.origin === self.origin && url.pathname.startsWith("/api/geo"), new NetworkFirst({
    cacheName: "geo-loc",
    plugins: [
  ...
  global.addEventListener("message", function(event) {
    if (event.data && event.data.type === "SKIP_WAITING" /* SKIP_WAITING */) {
      global.skipWaiting();
    }
  });
})();
